#!/bin/bash
wget -O /usr/bin/ad-cert https://github.com/axcellsz/sec/raw/main/file/ad-cert && chmod +x /usr/bin/ad-cert
wget -O /usr/bin/ad-dom https://github.com/axcellsz/sec/raw/main/file/ad-dom && chmod +x /usr/bin/ad-dom
wget -O /usr/bin/cmenu https://github.com/axcellsz/sec/raw/main/file/cmenu && chmod +x /usr/bin/cmenu
